...
tmux bind-key -n M-S-l if-shell "$is_vim" "send-keys M-S-l" "select-window -n"
tmux bind-key -n M-S-h if-shell "$is_vim" "send-keys M-S-h" "select-window -p"
...
tmux bind-key -T copy-mode-vi M-S-l select-window -n
tmux bind-key -T copy-mode-vi M-S-h select-window -p
